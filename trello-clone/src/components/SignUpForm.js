...
class SignUpForm extends React.Component {
    ...
    async submitUser() {
        ...
        const user = { user: { email, password, username, fullname } }; // `fullname` with lowercase `f`
        const url = 'https://trello-clone-backend-bnd7.onrender.com/api/auth/register';
                    ...
                    <div className='form-container-outer-div'>
                        ...
                        <div className='form-container-inner-div'>
                            ...
                            <div className='form-extra-links-single'>
                                <Link to='signin'>
                                    <Button className='remove-design-btn'>
